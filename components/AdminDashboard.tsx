        ...
        if (loading) {
            return (
                <main className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <AdminCard
                        icon={<div className="bg-purple-100 p-3 rounded-lg"><CarManagementIcon className="w-6 h-6 text-purple-600" /></div>}
                        title="Car Management"
                        description="Add, edit, and manage your car inventory with photos and specifications."
                        status={<span className="text-gray-500">Loading...</span>}
                    />
                    <AdminCard
                        icon={<div className="bg-green-100 p-3 rounded-lg"><BookingManagementIcon className="w-6 h-6 text-green-600" /></div>}
                        title="Booking Management"
                        description="View and manage customer bookings and cancellations."
                        status={<span className="text-gray-500">Loading...</span>}
                    />
                    <AdminCard
                        icon={<div className="bg-blue-100 p-3 rounded-lg"><UserManagementIcon className="w-6 h-6 text-blue-600" /></div>}
                        title="User Management"
                        description="View and manage registered users."
                        status={<span className="text-gray-500">Loading...</span>}
                    />
                    <AdminCard
                        icon={<div className="bg-purple-100 p-3 rounded-lg"><LicenseVerificationIcon className="w-6 h-6 text-purple-600" /></div>}
                        title="License Verification"
                        description="Review and verify customer driver's licenses with AI."
                    />
                    <AdminCard
                        icon={<div className="bg-pink-100 p-3 rounded-lg"><PromoCodeIcon className="w-6 h-6 text-pink-600" /></div>}
                        title="Promo Codes"
