    ...
    <div className="bg-neutral-lightgrey min-h-screen p-4 sm:p-6 lg:p-8 font-sans">
      <div className="max-w-7xl mx-auto">
        <header className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-neutral-charcoal">User Management</h1>
        ...
        <main>
          <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm text-center">
            ...
            <p className="text-gray-500 mt-2">This section is under construction. You will soon be able to manage user roles and view customer details.</p>
          </div>
        </main>
      </div>
    </div>
