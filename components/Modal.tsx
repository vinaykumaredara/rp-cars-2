  ...
  return (
    ...
    >
      ...
      >
        ...
        <button type="button" onClick={handleGoogleSignIn} disabled={loading} className="w-full py-3 flex items-center justify-center rounded-lg border border-gray-300 text-foreground font-medium hover:bg-gray-50 transition-all duration-300 disabled:bg-gray-200">
